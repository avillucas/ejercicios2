...
namespace Ejercicio_48
{
    ...
    class Program
    {
        ...
        {
            Competencia<AutoF1> grandPrix = new Competencia<AutoF1>(10, 2, Competencia<AutoF1>.TipoCompetencia.F1);
            Competencia<MotoCross> motoPrix = new Competencia<MotoCross>(15, 3, Competencia<MotoCross>.TipoCompetencia.MotoCross);
